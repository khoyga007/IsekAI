...
| **Nhân vật** | Pipeline avatar: AniList canon match (miễn phí) → sigil procedural fallback. Mỗi NPC có `register` + `tic` riêng để giữ giọng khác biệt. |
...
- **Avatar**: AniList GraphQL (chân dung canon) + sigil SVG procedural — không có AI image generation, $0
...
4. Đóng Settings → click 1 trong 4 thẻ trên màn hình landing → bắt đầu campaign
...
| **Google Gemini** 2.5 Pro/Flash | Implicit caching miễn phí. Context dài. Free tier hào phóng. |
